...
from akm.realworld_environment.obj_env import ObjEnv
from akm.realworld_environment.robot_env import clean_pc_np
...
class ExploreEnv(ObjEnv):
    ...
    def check_valid(self, visualize=False): 
        ...
        #     visualize=visualize
        # ) 
        # self.obj_repr.save("/home/user/Programs/AKM/assets/unit_test/test.npy")
