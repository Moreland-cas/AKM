...
from embodied_analogy.realworld_environment.explore_env import ExploreEnv
from embodied_analogy.representation.basic_structure import Frame
from embodied_analogy.project_config import MOVING_LABEL
...
class ReconEnv(ExploreEnv):
    ...
    def update_cur_frame(self, init_guess=None, visualize=False):
        ...
        if visualize:
            ...
            from embodied_analogy.utility.utils import joint_data_to_transform_np
