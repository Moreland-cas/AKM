...
def analyze(run_name="6_21"):
    ...
    print_path = f"/home/zby/Programs/Embodied_Analogy/assets/analysis_batch/{run_name}.txt"
    ...
    save_path = f"/home/zby/Programs/Embodied_Analogy/assets/analysis_batch/{run_name}.npy"
