...
from torchmetrics import MeanMetric, Precision, Recall
...
class GeoArtModelV0(pl.LightningModule):
    def __init__(self, opt, network):
        ...
        self.occ_pr_meter = Precision(task="binary", average="micro")
        self.occ_rc_meter = Recall(task="binary", average="micro")
        self.seg_pr_meter = Precision(task="binary", average="micro")
        self.seg_rc_meter = Recall(task="binary", average="micro")
        self.occ_iou_meter = MeanMetric()
        self.seg_iou_meter = MeanMetric()

        self.revoluted_axis_ori_meter = MeanMetric()
        self.revoluted_degree_meter = MeanMetric()
        self.revoluted_p2l_ori_meter = MeanMetric()
        self.revoluted_p2l_dist_meter = MeanMetric()
        self.revoluted_displacement_meter = MeanMetric()

        self.prismatic_axis_ori_meter = MeanMetric()
        self.prismatic_offset_meter = MeanMetric()
